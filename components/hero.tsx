            ...
            >
                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 relative z-10">
                    ...
                    <div className="text-center">
                        ...
                        Explore Bhutan: A Journey Beyond the Ordinary
                        </h1>
                        <p className="mt-6 text-lg leading-8 text-gray-300">
Uncover the magic of Bhutan’s untouched nature, ancient monasteries, and vibrant culture. Let us guide you through a one-of-a-kind adventure in the last Himalayan kingdom.                            </p>
